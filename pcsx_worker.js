...
var wasmBinaryFile;
  wasmBinaryFile = 'pcsx_worker.wasm';
...
var ASM_CONSTS = {
  251368: ($0) => { setTimeout("pcsx_mainloop()", $0); },  
 251407: () => { FS.mkdir('/home/web_user/.pcsx'); clear_event_history(); },  
 251468: ($0, $1, $2, $3, $4, $5, $6) => { render($0,$1,$2,$3,$4,$5,$6); },  
 251500: ($0, $1) => { SendSound($0, $1); }
};
...
var _one_iter = Module['_one_iter'] = createExportWrapper('one_iter');
var _pcsx_init = Module['_pcsx_init'] = createExportWrapper('pcsx_init');
var _ls = Module['_ls'] = createExportWrapper('ls');
...
// include: /Users/justinbrower/Desktop/pcsxjs/worker_funcs.js
var Module;
if (!Module) Module = {};
...
// end include: /Users/justinbrower/Desktop/pcsxjs/worker_funcs.js
